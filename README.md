...
| [健身会员数据分析](./健身房数据分析/process.ipynb)       |  离线处理  | pandas读取  + matplotlib+seaborn可视化 + numpy+使用sklearn进行KMeans聚类分析 (使用ipynb文件) | [COVID-19](https://www.heywhale.com/mw/project/673ff371e73f112f2eda6a22/dataset) ./dataset/中已经将数据下载好了
